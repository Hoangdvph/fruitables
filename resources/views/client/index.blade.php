            ...
            <div class="tab-class text-center">
                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            ...
                            {{-- @foreach ($categories as $id =>  $name)
                                <li class="nav-item">
                                    <a class="d-flex py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-{{ $id + 1 }}">
                                        <span class="text-dark" style="width: 130px;">{{ $name }}</span>
                                    </a>
                                </li>
                            @endforeach --}}

                            @foreach ($productAll as $key => $category)
                                <li class="nav-item">
                                    <a class="d-flex py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-{{ $loop->index }}">
                                        <span class="text-dark" style="width: 130px;">{{ $key }}</span>
                                    </a>
                                </li>
                            @endforeach
                ...
                <div class="tab-content">
                    @foreach ($productAll as $key => $pro)
                        <div id="tab-{{ $loop->index }}" class="tab-pane fade show p-0 {{ $key == 'All product' ? 'active' : '' }} ">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        @foreach ($pro as $item)
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item">
                                                    ...
                                                    <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                        style="top: 10px; left: 10px;">{{ $key }}</div>
                                ...
                                <div class="row g-4">
                                    @foreach ($products as $product)
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img src="{{ Storage::url( $product->image ) }}" class="img-fluid w-100 rounded-top"
                                                        alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
