                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="border rounded">
                                <a href="#">
                                    <img src="{{ Storage::url($productDetail->image) }}" class="img-fluid rounded" alt="Image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                        ...
                                        <div class="row g-4">
                                            <div class="col-6">
                                                <div
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-0">{{ $productDetail->weight }}</p>
                                                    </div>
                                                </div>
                                                <div class="row text-center align-items-center justify-content-center py-2">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-0">{{ $productDetail->origin }}</p>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-0">{{ $productDetail->quality }}</p>
                                                    </div>
                                                </div>
